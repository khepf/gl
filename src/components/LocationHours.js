...
class LocationHours extends Component {
  render() {
    ...
    <div className="LocationHours">
      ...
      <h3>Stop By and Say Hello!</h3><br/>
      11908 Kemper Rd<br/>
Loveland, OH<br/>  45140-2413<br/><br/>
Phone: (513) 200-3498<br/>
Fax: (513) 200-3499<br/><br/>
Hours:<br/>
Mon-Fri: 7am-6pm<br/>
Sat: 7am-4pm<br/>
Sun: 10am-4pm </div>
      </div>
      <img src={aboutPic1} alt="LocationHours Pic" className="LocationHoursPic"/>
      </section>
